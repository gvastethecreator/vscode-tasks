...
await verifyAlphaPng(path.join(media, "preview-settings.png"), 1200, 800, "Settings preview");
console.log("Media checks passed: approved raster icon and two native-alpha 1200x800 previews.");
